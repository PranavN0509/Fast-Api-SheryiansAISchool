...
# Response model i.e. response_model tells us what the function will return
# Depends is used in each function so that the function passes in Depends runs on each function call
...
def get_product_by_id(
    product_id: str = Path(
        ...
        examples="c47ea2457-c4a9-4bfg-9dd5-6464r0ebe343",
    )
):
    products = get_all_products()
